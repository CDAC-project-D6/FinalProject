  ...
  return (
    <div className="bg-gray-300 p-8 rounded-lg shadow-md">
      ...
      <div className="flex flex-col space-y-4 mt-4 ">
        ...
        <div className=" flex  gap-3 ">
        <GlobeIcon/><p className="text-xl ">www.HouseHopper.com</p> 
        </div>
        <div className=" flex  gap-3 ">
        <MailIcon/><p className="text-xl ">supporthousehopper@gmail.com</p>  
        </div>
        <div className=" flex  gap-3 ">
        <AddressIcon/><p className="text-xl ">HouseHopper head office, Arundhati Complex, Hinjewadi phase-2, bodakewadi </p>  
        </div>
      </div>
    </div>
  );
